...

{
  ...
  config = {
    ...
    let
      ...
      splitEOF2 = builtins.split "\nEOF" (lib.last splitEOF1);
      EOFContent = builtins.head splitEOF2;
      splitReplace = lib.concatStrings [ (builtins.head splitEOF1) "EOFCONTENT" (lib.last splitEOF2) ];
      ...
      postBuild = builtins.replaceStrings ["EOFCONTENT"] [EOFContent] beforeReplaceEOF;
    in 
      pkgs.buildEnv {
